...
public class View360Activity extends AppCompatActivity {
...
//    }
    ...
    private static final String TAG = View360Activity.class.getSimpleName();
...
//                    istr = assetManager.open("test360.jpg");
...
//                    panoOptions.inputType = VrPanoramaView.Options.TYPE_STEREO_OVER_UNDER;
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    View360Activity.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
